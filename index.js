let razas= [//descripcion de los humanos!
  { id:"historia_humanos",
    title: '<div><h1>Esta es la raza humana, su capital era Lordaeron, era gobernada por el rey Therenas</h1></div><br><img src="./cuidades/Lordaeron.png" alt="">',
    icon: '',
    html:
      'El rey Therenas que hizo muchas alianzas con magos y otras razas, luego, su hijo, el principe Arthas, cegado y enloquecido por sus deciciones y el poder de su espada runica maldita llamada Frostmourne los extermino a todos en el reino, empezando por su padre y rey, therenas',
    ...
    personajes: [{ id: "personaje",
        title: '<div class="titulo"><strong>El principe Arthas</strong></div><br><img src="./personajes/arthas.jfif" alt="">',
        icon: '',
        html:
          'Arthas tratando de liberar a su pueblo y patria de la muerte y acabar con la amenaza de los muertos vivientes llevo a cabo muchas atrocidades, como masacrar el pueblo de stratholme y empuñar la espada maldita Frostmourne, esta espada poseia la voluntad del rey lich, este ser lo enloquecio y lo convirtio a Arthas en su caballero de la muerte, esto hizo que Arthas asesinara a su ejercito y a todo su pueblo',
        showCloseButton: true,
        showCancelButton: false,
        focusConfirm: false,
        confirmButtonText:'OK!',
    ...
    { id:"personaje_jaina",
      title: '<h1><strong>La maga Jaina</strong></h1><br><img src="./personajes/jaina.jfif" alt="">',
      icon: '',
      html:
        'Jaina, hija del rey de theramore, princesa de una gran ciudad, pretendiente de la mano de Arthas, era una joven y muy prodigiosa maga que se enfrento a los muertos viventes al igual que su futuro esposo, pero tomo un rumbo diferente, para empezar ella no vio logico participar en la masacre de stratholme, escucho las palabras de un sabio y muy poderoso mago llamado Medivh y se fue a las lejanas tierras de Kalimdor para hacer alianza con el lider orco y los representantes de los elfos, para combatir entre todos al lider de los muertos vivientes y causante de gran parte de los males del mundo, Archimonde',
      showCloseButton: true,
      showCancelButton: false,
      focusConfirm: false,
      confirmButtonText:'OK!',
      ...
      { id:"personaje_muradin",
        title: '<div class="titulo"><strong>El principe Arthas</strong></div><br><img src="./personajes/Muradin.png" alt="">',
        icon: '',
        html:
          'Muradin, un enano perdido en el paramo helado de Northrend, se encontro con Arthas, cuando era un principe y un paladin, se unio a su viaje para acabar con Malganis y con los muertos vivientes, Muradin le explico a Arthas que era la Frostmourne, sin saber de quien era y si estaba maldita, pero sabia que era poderosa y podia ser util, cuando Arthas y el llegaron a ver la espada, derrotando a sus guardianes, Muradin vio que estaba maldita al leer la inscripcion escrita en la espada. pero al principe le dio igual, el queria sacrificarse con tal de salvar a su pueblo, al liberar la espada exploto la jaula de la misma, unos cristales se clavaron en el corazon del enano, causandole la muerte',
        showCloseButton: true,
        showCancelButton: false,
        focusConfirm: false,
        confirmButtonText:'OK!',
  ...
  { id:"historia_orcos",
    title: '<strong>Esta es la raza Orca, su capital es Durotar, es gobernada por Thrall, entre otros</strong><br><img src="./cuidades/Orgrimmar.webp" alt="">',
    icon: '',
    html:
      'Thrall a lo largo de su vida tuvo que pelear contra todo tipo de cosas, arpias, humanos, orcos, demonios e incluso el rey de los demonios, Archimonde, sus mas grandes cualidades son su inteligencia, sus habilidades y su logica para hacer alianzas con todo tipo de razas',
    showCloseButton: true,
    showCancelButton: false,
    focusConfirm: false,
    confirmButtonText:'OK!',
    ...
    personajes: [
      { 
        id: "personajeorco",
        title: '<div class="titulo"><strong>Thrall, el vidente</strong></div><br><img src="./personajes/Thrall.png" alt="">',
        icon: '',
        html:
          'Thrall es el hijo de Durotan, fue esclizado entre los humanos y se libero, el sueña con un mundo donde los humanos y orcos puedan convivir juntos en paz, pero, para eso tenia que convatir dia a dia contra los propios orcos y los humanos por sus conflictos, decidio seguir los consejos del mago medivh y se fue a kalimdor, para crear su ciudad llamada "Durotar" en honor a su padre, pero sus al llegar a kalimdor sus barcos se dispersaron, su mejor amigo Grom se revelo y empezo a luchar contra los humanos refugiados de Jaina, luego, tuvo que aliarse con Jaina para derrotar a Grom que habia caido en el control de los demonios y tenian que liberarlo, luego de liberarlo el y Grom pelearon contra el demonio y al matarlo Grom se sacrifico, salvandole la vida a thrall, y estando en paz con los humanos de Jaina, de manera temporal',
        showCloseButton: true,
        showCancelButton: false,
        focusConfirm: false,
        confirmButtonText:'OK!',
    ...
    { id:"personaje_cairne",
      title: '<div class="titulo"><strong>Cairne Bloodhoof</strong></div><br><img src="./personajes/Cairne.png" alt="">',
      icon: '',
      html:
        'Cairne fue el lider de los taurens, es una raza pacifica, inteligente y extremadamente pacifica, Cairne y su pueblo estaba siendo masacrado por sus enemigos los centauros, cuando conocio a Thrall y a sus hombres le inspiro su pasion por defender lo que creen y se unio a los orcos y a su horda',
      showCloseButton: true,
      showCancelButton: false,
      focusConfirm: false,
      confirmButtonText:'OK!',
      ...
      { id:"personaje_grom",
        title: '<div class="titulo"><strong>Grommash hellscream</strong></div><br><img src="./personajes/Grom.png" alt="">',
        icon: '',
        html:
          'Grom fue criado como todo orco normal, a diferecia de su amigo y jefe Thrall que se crio con humanos, el al enfrentarse contra los elfos nocturnos y su lider Cenarius que era un semidios, Grom se vio abrumado por sus poderes hasta que se entero que habia una fuente que resulto ser una trampa que tenia sangre de un demonio muy poderoso, Grom al tomar la sangre se convirtio en un ser mucho mas grande y mas fuerte, obligo a sus soldados a beber de la fuente y con ese nuevo poder derrotaron y asesinaron a Cenarius pero luego el y sus hombres pertenecieron a el demonio, tuvo que enfrentarce a Thrall y luego enfrentar al demonio, siendo asi, su ultimo combate',
        showCloseButton: true,
        showCancelButton: false,
        focusConfirm: false,
        confirmButtonText:'OK!',
...
function agregarEventListener(elementoHistoria){
  let historia=document.getElementById(elementoHistoria.id)
  historia.addEventListener("click", function(){
  Swal.fire(elementoHistoria)
 })
}
razas.forEach(function(raza){
  agregarEventListener(raza)
  raza.personajes.forEach(function(personaje){
    agregarEventListener(personaje)
 })
})
